...
import {getCppRecursionQuizContent} from '@site/src/data/cppRecursionContent';
...
export default function CppRecursionQuiz({quiz}) {
  const {language} = useLanguage();
  const defaultQuiz = getCppRecursionQuizContent(language);
  const localizedQuiz = {
    ...defaultQuiz,
    ...quiz,
    labels: {
